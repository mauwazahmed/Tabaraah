...
if st.button("Calculate Total Cost"):
    ...
    st.success(f"Total Cost (excl GST): Rs {total_cost} + Delivery Charges (as applicable)")
    st.success(f"Total Cost (incl GST): Rs {total_cost*1.18} + Delivery Charges (as applicable)")
